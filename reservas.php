...
<body>
    ...
    <main>
        <section>
            ...
            <p>Utiliza nuestro sistema para realizar reservas en alojamientos y restaurantes de San Martín del Rey Aurelio.</p>
            <p>Garantiza tu plaza en los mejores establecimientos del concejo.</p>
        </section>
        
        <section>
            <h2>Formulario de reserva</h2>
            <p>Rellena el siguiente formulario para realizar tu reserva:</p>
            
            <form action="procesar_reserva.php" method="post">
                <!-- Aquí iría el código PHP para el formulario de reserva -->
                <p>El sistema de reservas estará disponible próximamente.</p>
            </form>
        </section>
    </main>
